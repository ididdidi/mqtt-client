...
public class MQTTClient
{
    ...
    public void Connect(String userName, String password, @NonNull EventHandler handler)
    {
        ...
        try {
            ...
            handler.OnFailureMQTT("Error!" + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    public void Subscribe(@NonNull String topic, int qos, @NonNull EventHandler handler)
    {
        ...
        try {
            ...
            subToken.setActionCallback(new IMqttActionListener() {
                ...
                @Override
                public void onSuccess(IMqttToken asyncActionToken) {
                    // The subscription could successfully be added
                    handler.OnSuccessMQTT("Subscribe " + topic);
                }
                ...
                public void onFailure(IMqttToken asyncActionToken,
                    ...
                    handler.OnFailureMQTT("Subscribe " + topic + " is failed.");
                }
            });

        } catch (MqttException e) {
            handler.OnFailureMQTT("Failed subscribing to " + topic + " " + e.getMessage());
            e.printStackTrace();
        }
    }
    ...
    public void Unsubscribe(@NonNull String topic, @Nullable EventHandler handler)
    {
        ...
        try {
            ...
            e.printStackTrace();
            handler.OnFailureMQTT("Unsubscribe " + topic + " is failed: " + e.getMessage());
        }
    }
